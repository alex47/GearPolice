...
- Never change the addon version, add a numbered release heading, or choose the next version without discussing it with the user first and receiving explicit approval. Do not infer a version bump from the size or type of a change.
